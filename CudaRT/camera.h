...
public:
    ...
    __device__ Camera(Vec3f32 lookfrom, Vec3f32 lookat, Vec3f32 vup, float vfov, float aspect, float aperture, float focus_dist, Vec3f32 background_color = Vec3f32(0.7, 0.8, 1.0)) {
